...
class ZohoHttpConnectionConnection:
    ...
    def _refresh_token(self) -> None:
        ...
        api_domain: str = str(data.get("api_domain") or "").rstrip("/")
        if api_domain:
    ...
    def request(self, method: str, path: str, params: dict[str, Any] | None = None, json: Any = None, headers: dict[str, str] | None = None) -> tuple[int, Any]:
        ...
        response: requests.Response = self._api_session.request(method=method, url=url, params=params, json=json, headers=request_headers, timeout=(5, 30))
