        ...
        json.dumps(
            {
                "event": "route_entry",
                "method": "PUT",
                "path": "/consent/{consent_id}/withdraw",
            }
        )
    )
...
async def get_consent_all(request: Request, patient_id: str) -> ConsentGetAllResponse:
    logger.info(
        json.dumps(
            {
                "event": "route_entry",
                "method": "GET",
                "path": "/consent/{patient_id}",
            }
        )
    )
...
async def get_consent_one(request: Request, patient_id: str, purpose: str) -> ConsentGetOneResponse:
    logger.info(
        json.dumps(
            {
                "event": "route_entry",
                "method": "GET",
                "path": "/consent/{patient_id}/{purpose}",
            }
        )
    )
