...
async def get_payments(request: Request, userId: str | None = None, planId: str | None = None, status: str | None = None, paymentMethod: str | None = None, currency: str | None = None, dateFrom: str | None = None, dateTo: str | None = None, page: int = 1, pageSize: int = 20) -> PaymentListResponse:
    try:
