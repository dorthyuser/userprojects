...
public sealed class SupportedCurrenciesResponse
{
    ...
    public List<SupportedCurrencyItemResponse> SupportedCurrencies { get; set; } = [];
}

public sealed class SupportedCurrenciesListResponse
{
    [JsonPropertyName("currencies")]
    public List<SupportedCurrencyItemResponse> Currencies { get; set; } = [];
}
...
public sealed class CurrencyAmountResponse
{
...
public sealed class CurrencyOnlyResponse
{
    [JsonPropertyName("currency")]
    public string Currency { get; set; } = string.Empty;
...
public sealed class FeesResponse
{
...
public sealed class CalculateResponse
{
    ...
    public CurrencyAmountResponse Source { get; set; } = new();

    [JsonPropertyName("destination")]
    public CurrencyOnlyResponse Destination { get; set; } = new();
    ...
    public FeesResponse Fees { get; set; } = new();
