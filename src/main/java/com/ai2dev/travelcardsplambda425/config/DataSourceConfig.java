package com.ai2dev.travelcardsplambda425.config;
...
public class DataSourceConfig {
    ...
    public DataSource dataSource() {
        String secretName = System.getenv().getOrDefault("DB_SECRET_NAME", "SECRET_NAME");
        ...
        try (SecretsManagerClient client = SecretsManagerClient.builder()
            ...
            cfg.setPoolName("travelcardsplambda425HikariPool");
