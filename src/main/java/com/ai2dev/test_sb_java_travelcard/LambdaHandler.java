package com.ai2dev.test_sb_java_travelcard;
...
public class LambdaHandler implements RequestStreamHandler {
    ...
    static {
        try {
            log.info("Initializing Spring Boot Lambda Container Handler");
            handler = SpringBootLambdaContainerHandler.getAwsProxyHandler(Application.class);
            log.info("Spring Boot Lambda Container Handler initialized");
    ...
    public void handleRequest(InputStream in, OutputStream out, Context ctx) throws IOException {
        log.info("LambdaHandler.handleRequest entered");
        try {
            ...
            log.info("LambdaHandler.handleRequest exiting");
        }
    }
}
