...
public class Travelcard {
    ...
    public Travelcard(Long id, TravelcardType travelcardType, OffsetDateTime travelcardValidFrom, OffsetDateTime travelcardValidTo, String travelcardName, String travelcardNumber, OffsetDateTime travelcardRequestedDate, String travelcardTransactionReference, OffsetDateTime travelcardUsableTo, List<Cardholder> cardholders) {
        this.id = id;
