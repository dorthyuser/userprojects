package com.ai2dev.sb_lambda_testing.config;
...
public class DataSourceConfig {
    ...
    public DataSource dataSource() {
        logger.info("Configuring HikariDataSource from environment variables");
        ...
        config.setPoolName("sb-lambda-testingHikariPool");
